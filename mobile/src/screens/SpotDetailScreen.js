  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.hero}>
        ...
        {/* Full gradient overlay like web */}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.tagsRow}>
            <View style={styles.tag}>
              <Text style={styles.tagText}>📍 {spot.city}</Text>
            </View>
            <View style={styles.tag}>
              <Text style={styles.tagText}>{PRICE_LABELS[spot.priceRange]}</Text>
            </View>
            <View style={styles.tag}>
              <Text style={styles.tagText}>🏷️ {spot.category}</Text>
            </View>
          </View>
...
{spot.latitude && spot.longitude && (
  <View style={styles.section}>
    ...
    <View style={styles.mapPreview}>
      <Image
        source={{
          uri: `https://staticmap.openstreetmap.de/staticmap.php?center=${spot.latitude},${spot.longitude}&zoom=15&size=600x200&markers=${spot.latitude},${spot.longitude},red`
        }}
...
const styles = StyleSheet.create({
  ...
  // Hero — taller like web (480px equivalent)
  ...
  heroOverlay: {
    ...
    // Simulates web gradient: linear-gradient(to top, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.2) 60%, transparent 100%)
  ...
  sectionTitle: {
    fontSize: 20, fontWeight: '700', color: COLORS.dark,
    marginBottom: 14,
  },
  reviewCount: {
    fontSize: 14, color: COLORS.textLight, fontWeight: '500',
  },
  description: {
    fontSize: 15, color: COLORS.text, lineHeight: 24, marginBottom: 16,
  },
  ...
  // Review card — cream background like web
  reviewCard: {
    backgroundColor: COLORS.cream,
